...
public class DriverRegLoginActivity extends AppCompatActivity {
    ...
    ProgressDialog loadingBar;  //Экран загрузки
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signUpBtn.setVisibility(View.INVISIBLE);  //сделали кнопку невидимой
        signUpBtn.setEnabled(false);              //не нажимается
                ...
                mAuth.signInWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful())
                        {
                            ...
                            Intent driverIntent = new Intent(DriverRegLoginActivity.this, DriverMapActivity.class);
